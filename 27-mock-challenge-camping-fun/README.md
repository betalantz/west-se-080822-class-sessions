...
- [x] Start by creating the models and migrations for the following database tables:
...
- [x] Add any code needed in the model files to establish the relationships.
